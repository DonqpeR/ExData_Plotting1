...
plot(x, res$Global_active_power, type="l", xlab="", ylab="Global Active Power")
...
plot(x, as.numeric(res$Voltage), type="l", xlab="datetime", ylab="Voltage")
plot(x, as.numeric(res$Global_reactive_power), type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
